class CreateGames < ActiveRecord::Migration[6.0]
  def change
    ...
    create_table :players do |t|
      t.integer :team_id
      t.string :name
      t.integer :water_stat, null: false, default: 5
      t.integer :food_stat, null: false, default: 5
      t.integer :stamina_stat, null: false, default: 5
      t.integer :strength_stat, null: false, default: 5
